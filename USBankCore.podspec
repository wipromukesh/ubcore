...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.2"
  spec.summary      = "A short description of USBankCore."
  ...
  # Or just: spec.author    = "wipromukesh"
  # spec.authors            = { "wipromukesh" => "mukesh.lokare@wipro.com" }
  # spec.social_media_url   = "https://twitter.com/wipromukesh"
  ...
  spec.source       = { :git => "https://github.com/wipromukesh/ubcore.git", :tag => "0.0.2" }
  ...
  #
	...
	spec.source_files  = 'USBankCore/Classes/**/*'
